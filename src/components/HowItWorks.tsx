...
const steps = [
  {
    ...
    description: "Expliquez votre histoire, uploadez votre visage et votre musique, définissez le style artistique."
  },
  {
    icon: Wand2,
    number: "02",
    title: "L'IA crée votre vidéo",
    description: "Notre technologie SORA 2 génère votre clip complet avec une cohérence visuelle parfaite."
  },
  {
    icon: Video,
    number: "03",
    title: "Prévisualisez et ajustez",
    description: "Visionnez votre création et affinez les détails si nécessaire avant l'export final."
  },
  {
    icon: Download,
    number: "04",
    title: "Exportez en qualité 4K",
    description: "Téléchargez votre vidéo finale en haute définition, prête à être partagée."
  }
];
