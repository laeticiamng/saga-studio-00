...
const steps = [
  ...
  { icon: Wand2, number: "02", title: "L'IA crée votre vidéo", description: "Notre technologie SORA 2 génère votre clip complet avec une cohérence visuelle parfaite." },
  ...
  { icon: Download, number: "04", title: "Exportez en qualité 4K", description: "Téléchargez votre vidéo finale en haute définition, prête à être partagée." },
];
