...
const features = [
  ...
  { icon: CheckCircle, title: "Qualité premium", description: "Export en 4K avec la meilleure qualité disponible sur le marché grâce à SORA 2.", gradient: "from-yellow-600 to-orange-500", isNew: true },
];
