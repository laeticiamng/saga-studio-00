...
const features = [
  ...
  { icon: Sparkles, title: "Cohérence visuelle", description: "Un style artistique uniforme et des transitions fluides du début à la fin de votre vidéo.", gradient: "from-yellow-500 to-orange-500" },
  ...
  { icon: CheckCircle, title: "Qualité premium", description: "Export en 4K avec la meilleure qualité disponible sur le marché grâce à SORA 2.", gradient: "from-yellow-600 to-orange-500" },
];
          ...
          {features.map((feature, index) => (
            <AnimatedSection key={index} delay={0.08 * (index + 1)}>
              <motion.div whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 300, damping: 20 }}>
                <Card className="p-6 bg-gradient-card backdrop-blur-sm border-border/50 hover:shadow-elevated transition-all duration-300 group h-full">
