    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="max-w-none space-y-6 text-muted-foreground">
          ...
          <p className="text-sm italic">Les informations complètes de l'entité éditrice (raison sociale, SIRET, adresse) seront publiées prochainement.</p>
          ...
          <p>Le directeur de la publication sera communiqué prochainement.</p>
