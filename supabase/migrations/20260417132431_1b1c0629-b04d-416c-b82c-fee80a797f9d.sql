...
DROP VIEW IF EXISTS public.architecture_health_snapshot;
CREATE VIEW public.architecture_health_snapshot
...
-- Re-create trigger functions with explicit search_path (already had it, but ensure consistency)
